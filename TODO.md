...
- [ ] Add a GitHub Actions workflow that runs tests, builds a wheel and proves
  installation from `git+https://github.com/if-uri/urirun-connector-http-check.git@main`.
